...
res = session.post('http://127.0.0.1:5000/register', data={'username': 'testuser2', 'email': 'testuser2@test.com', 'password': 'Password123', 'csrf_token': csrf})

# Login
csrf = get_csrf('http://127.0.0.1:5000/login')
res = session.post('http://127.0.0.1:5000/login', data={'email': 'testuser2@test.com', 'password': 'Password123', 'csrf_token': csrf})
